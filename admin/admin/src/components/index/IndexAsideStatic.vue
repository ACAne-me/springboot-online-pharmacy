<template>
	<div class="menu-preview" >
		<!-- 竖向-2 -->
		<el-scrollbar :style='{"background":"none"}' :wrap-class="isCollapse ? 'scrollbar-wrapper scrollbar-wrapper-close' : 'scrollbar-wrapper scrollbar-wrapper-open'">
