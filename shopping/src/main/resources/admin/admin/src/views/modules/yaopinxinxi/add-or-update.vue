<template>
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="药品名称" prop="yaopinmingcheng">
					<el-input v-model="ruleForm.yaopinmingcheng" placeholder="药品名称" clearable  :readonly="ro.yaopinmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="药品名称" prop="yaopinmingcheng">
					<el-input v-model="ruleForm.yaopinmingcheng" placeholder="药品名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="药品分类" prop="yaopinfenlei">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="药品分类" prop="yaopinfenlei">
					<el-input v-model="ruleForm.yaopinfenlei"
						placeholder="药品分类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-if="type!='info' && !ro.yaopintupian" label="药品图片" prop="yaopintupian">
					<file-upload
						tip="点击上传药品图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-else-if="ruleForm.yaopintupian" label="药品图片" prop="yaopintupian">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="药品规格" prop="yaopinguige">
					<el-input v-model="ruleForm.yaopinguige" placeholder="药品规格" clearable  :readonly="ro.yaopinguige"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="药品规格" prop="yaopinguige">
					<el-input v-model="ruleForm.yaopinguige" placeholder="药品规格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="药品品牌" prop="yaopinpinpai">
					<el-input v-model="ruleForm.yaopinpinpai" placeholder="药品品牌" clearable  :readonly="ro.yaopinpinpai"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="药品品牌" prop="yaopinpinpai">
					<el-input v-model="ruleForm.yaopinpinpai" placeholder="药品品牌" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="生产日期" prop="shengchanriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.shengchanriqi" label="生产日期" prop="shengchanriqi">
					<el-input v-model="ruleForm.shengchanriqi" placeholder="生产日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="有效时间" prop="youxiaoshijian">
					<el-input v-model="ruleForm.youxiaoshijian" placeholder="有效时间" clearable  :readonly="ro.youxiaoshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="有效时间" prop="youxiaoshijian">
					<el-input v-model="ruleForm.youxiaoshijian" placeholder="有效时间" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="药品详情" prop="yaopinxiangqing">
					<editor 
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.yaopinxiangqing" label="药品详情" prop="yaopinxiangqing">
                    <span :style='{"border":"2px solid #c8c8c8","padding":"0 20px","color":"inherit","background":"none","display":"inline-block","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"350px","fontWeight":"500"}' v-html="ruleForm.yaopinxiangqing"></span>
                </el-form-item>
...
export default {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.alllimittimes = Number('100'); 
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.yaopinxiangqing = this.ruleForm.yaopinxiangqing.replace(reg,'../../../springboothc349102/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
