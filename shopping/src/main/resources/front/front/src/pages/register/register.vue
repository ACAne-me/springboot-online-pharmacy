<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231201/94181f4a19bc4abf8daff5310ff35259.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
        <el-form class='rgs-form' v-if="pageFlag=='security1'" :style='{"padding":"20px","margin":"0","borderRadius":"0","background":"rgba(0,0,0,0.5)","width":"600px","position":"absolute","right":"5%","height":"850px"}'>
			<div v-if="true" :style='{"width":"100%","margin":"0 0 10px 0","lineHeight":"44px","fontSize":"24px","color":"#E1B44F","textAlign":"center"}'>找回密码</p></div>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' prop="username">
				<div v-if="true" :style='{"width":"114px","lineHeight":"44px","fontSize":"14px","color":"#fff"}'>账号：</div>
				<el-input v-model="forgetForm.username" placeholder="请您输入账号" />
			</el-form-item>
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"0 0 6px rgba(64, 158, 255, .5)","margin":"20px auto 5px","color":"#fff","display":"block","outline":"none","borderRadius":"8px","background":"#e1b44f","width":"80%","fontSize":"24px","height":"44px"}' type="primary" @click="getSecurity()">下一步</el-button>
		...
		<el-form class='rgs-form' v-if="pageFlag=='security2'" :style='{"padding":"20px","margin":"0","borderRadius":"0","background":"rgba(0,0,0,0.5)","width":"600px","position":"absolute","right":"5%","height":"850px"}'>
			<div v-if="true" :style='{"width":"100%","margin":"0 0 10px 0","lineHeight":"44px","fontSize":"24px","color":"#E1B44F","textAlign":"center"}'>找回密码</p></div>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' prop="pquestion">
				<div v-if="true" :style='{"width":"114px","lineHeight":"44px","fontSize":"14px","color":"#fff"}'>密保问题：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' prop="myanswer">
				<div v-if="true" :style='{"width":"114px","lineHeight":"44px","fontSize":"14px","color":"#fff"}'>密保答案：</div>
				<el-input v-model="registerForm.myanswer" placeholder="请您输入密保答案" />
			</el-form-item>
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"0 0 6px rgba(64, 158, 255, .5)","margin":"20px auto 5px","color":"#fff","display":"block","outline":"none","borderRadius":"8px","background":"#e1b44f","width":"80%","fontSize":"24px","height":"44px"}' type="primary" @click="validateSecurity()">下一步</el-button>
			<router-link :style='{"cursor":"pointer","padding":"5px 10%","color":"#e1b44f","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"1","fontSize":"12px","textDecoration":"none"}' to="/login">已有账户登录</router-link>
		</el-form>
        <el-form class='rgs-form' v-if="pageFlag=='security3'" :style='{"padding":"20px","margin":"0","borderRadius":"0","background":"rgba(0,0,0,0.5)","width":"600px","position":"absolute","right":"5%","height":"850px"}'>
			<div v-if="true" :style='{"width":"100%","margin":"0 0 10px 0","lineHeight":"44px","fontSize":"24px","color":"#E1B44F","textAlign":"center"}'>找回密码</p></div>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' prop="newpassword">
				<div v-if="true" :style='{"width":"114px","lineHeight":"44px","fontSize":"14px","color":"#fff"}'>新密码：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' prop="repassword">
				<div v-if="true" :style='{"width":"114px","lineHeight":"44px","fontSize":"14px","color":"#fff"}'>确认密码：</div>
				<el-input v-model="registerForm.repassword" type="password" placeholder="请您确认密码" />
			</el-form-item>
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"0 0 6px rgba(64, 158, 255, .5)","margin":"20px auto 5px","color":"#fff","display":"block","outline":"none","borderRadius":"8px","background":"#e1b44f","width":"80%","fontSize":"24px","height":"44px"}' type="primary" @click="updatePassword()">修改密码</el-button>
			<router-link :style='{"cursor":"pointer","padding":"5px 10%","color":"#e1b44f","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"1","fontSize":"12px","textDecoration":"none"}' to="/login">已有账户登录</router-link>
        </el-form>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px","margin":"0","borderRadius":"0","background":"rgba(0,0,0,0.5)","width":"600px","position":"absolute","right":"5%","height":"850px"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"100%","margin":"0 0 10px 0","lineHeight":"44px","fontSize":"24px","color":"#E1B44F","textAlign":"center"}'>基于Spring Boot的网上药房注册</p></div>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="yonghuming">
				<div v-if="true" :style='{"width":"114px","lineHeight":"44px","fontSize":"14px","color":"#fff"}' :class="changeRules('yonghuming')?'required':''">用户名：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="shouji">
				<div v-if="true" :style='{"width":"114px","lineHeight":"44px","fontSize":"14px","color":"#fff"}' :class="changeRules('shouji')?'required':''">手机：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="pquestion">
				<div v-if="true" :style='{"width":"114px","lineHeight":"44px","fontSize":"14px","color":"#fff"}' :class="changeRules('pquestion')?'required':''">密保问题：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="panswer">
				<div v-if="true" :style='{"width":"114px","lineHeight":"44px","fontSize":"14px","color":"#fff"}' :class="changeRules('panswer')?'required':''">密保答案：</div>
