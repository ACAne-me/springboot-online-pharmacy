...
<div :style='{"width":"86%","padding":"20px","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    <div v-if="storeupType==1" class="section-title" :style='{"margin":"10px 0","fontSize":"24px","lineHeight":"54px","color":"#000","textAlign":"center","background":"#ffc054"}'>我的收藏</div>
    <div v-if="storeupType==51" class="section-title" :style='{"margin":"10px 0","fontSize":"24px","lineHeight":"54px","color":"#000","textAlign":"center","background":"#ffc054"}'>浏览历史</div>
