...
<div :style='{"width":"86%","padding":"20px","margin":"10px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="110px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="提问" prop="ask">
            <el-input v-model="ruleForm.ask" 
                placeholder="提问" clearable :disabled=" false  ||ro.ask"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="回复" prop="reply">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="回复"
