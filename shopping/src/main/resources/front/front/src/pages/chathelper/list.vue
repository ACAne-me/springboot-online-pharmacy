...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","margin":"20px 0","alignItems":"center","flexWrap":"wrap","background":"#FFC054","display":"flex","width":"100%","height":"auto"}'>
      <el-form-item :style='{"margin":"5px 10px"}'>
        ...
        <el-input v-model="formSearch.ask" placeholder="提问" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="btnAuth('chathelper','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#000","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/chathelperAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="sort_view" :style='{"boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","padding":"10px 16px 0 0","margin":"10px 10px 0 0","borderColor":"#FFC054","alignItems":"flex-end","flexDirection":"column","borderWidth":"0 0 0 2px ","display":"flex","width":"100px","borderStyle":"solid ","order":"2"}'>
		<el-button :style='{"border":"0","borderRadius":"0","padding":"0"}' @click="sortClick('clicknum')">
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        this.$http.get(`chathelper/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        ...
        this.$router.push({path: '/index/chathelperDetail', query: params});
      },
