  ...
  methods: {
    submitTap() {
      ...
      this.$confirm(`确定支付?`, "提示", {
        ...
        // 准备订单数据，用于settle接口
        let orderData = {
          orderid: this.obj.orderid || String(new Date().getTime()),
          tablename: this.obj.tablename,
          userid: localStorage.getItem('frontUserid'),
          goodid: this.obj.goodid,
          goodname: this.obj.goodname,
          goodtype: this.obj.goodtype,
          picture: this.obj.picture,
          buynumber: this.obj.buynumber,
          price: this.obj.price,
          total: Number(this.obj.total || (this.obj.price * this.obj.buynumber)),
          type: Number(this.obj.type || 1),
          ...
          status: '已支付',
          sfsh: this.obj.sfsh || '',
          role: localStorage.getItem('UserTableName'),
          ispay: "已支付"
        };
