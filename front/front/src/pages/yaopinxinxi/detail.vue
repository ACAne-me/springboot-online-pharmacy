		...
		<div class="attr" :style='{"width":"calc(100% - 500px)","margin":"0 0 0 30px","position":"relative","background":"#fff","display":"flex","order":"2"}'>
			...
			<div class="info" :style='{"width":"100%"}'>
				<div class="item" :style='{"margin":"0 0 10px 0","alignItems":"center","justifyContent":"space-between","display":"flex"}'>
					...
					<div @click="storeup(1)" v-show="!isStoreup" :style='{"border":"1px solid #00AA3A","cursor":"pointer","padding":"0","align-items":"center","display":"flex"}'><i v-if="true" :style='{"padding":"10px","fontSize":"20px","color":"#fff","background":"#00aa3a"}' class="el-icon-star-off"></i><span :style='{"color":"#00AA3A","padding":"10px","fontSize":"14px"}'>收藏({{detail.storeupnum}})</span></div>
				...
				<div class="item" :style='{"padding":"0 0 4px","margin":"0 0 5px 0","borderColor":"#f6f6f6","flexWrap":"wrap","borderWidth":"0 0 1px","display":"flex","borderStyle":"solid"}'>
					<div class="lable" :style='{"margin":"0 5px 0 0","color":"#000000","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>药品分类</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","flex":"1","height":"auto"}'>{{detail.yaopinfenlei}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0 4px","margin":"0 0 5px 0","borderColor":"#f6f6f6","flexWrap":"wrap","borderWidth":"0 0 1px","display":"flex","borderStyle":"solid"}'>
					<div class="lable" :style='{"margin":"0 5px 0 0","color":"#000000","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>药品规格</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","flex":"1","height":"auto"}'>{{detail.yaopinguige}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0 4px","margin":"0 0 5px 0","borderColor":"#f6f6f6","flexWrap":"wrap","borderWidth":"0 0 1px","display":"flex","borderStyle":"solid"}'>
					<div class="lable" :style='{"margin":"0 5px 0 0","color":"#000000","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>药品品牌</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","flex":"1","height":"auto"}'>{{detail.yaopinpinpai}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0 4px","margin":"0 0 5px 0","borderColor":"#f6f6f6","flexWrap":"wrap","borderWidth":"0 0 1px","display":"flex","borderStyle":"solid"}'>
					<div class="lable" :style='{"margin":"0 5px 0 0","color":"#000000","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>生产日期</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","flex":"1","height":"auto"}'>{{detail.shengchanriqi}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0 4px","margin":"0 0 5px 0","borderColor":"#f6f6f6","flexWrap":"wrap","borderWidth":"0 0 1px","display":"flex","borderStyle":"solid"}'>
					<div class="lable" :style='{"margin":"0 5px 0 0","color":"#000000","textAlign":"left","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>有效时间</div>
					<div  :style='{"padding":"0px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","flex":"1","height":"auto"}'>{{detail.youxiaoshijian}}</div>
				</div>
				...
				<div class="btn" :style='{"row-gap":"20px","width":"470px","padding":"10px 0","flexWrap":"wrap","display":"block"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 10px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#598969","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('yaopinxinxi','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 10px 0","color":"#fff","borderRadius":"4px","background":"#00AA3A","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('yaopinxinxi','删除')" @click="delClick">删除</el-button>
					
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 10px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#0F672D","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('yaopinxinxi','药品入库')" @click="onAcross('rukuxinxi','','','','')" type="warning">药品入库</el-button>
				</div>
			</div>
		</div>
			...
			<div class="hot" :style='{"width":"100%","margin":"20px 0 0","height":"auto","order":"4"}'>
			  <div :style='{"padding":"30px 0 20px 20px","color":"#343434","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231108/43ca4d5dbb6543fd8e747de9e2e6df60.png) no-repeat left center","width":"100%","lineHeight":"18px","fontSize":"18px"}'>热门信息</div>
			  <div :style='{"width":"100%","padding":"0","flexWrap":"wrap","justifyContent":"space-between","display":"flex","height":"auto"}'>
			    <!--热门推荐-->
				<div v-for="item in hotList" :key="item.id" :style='{"cursor":"pointer","width":"23%","padding":"5px 5px 0","margin":"0 0 20px","float":"left"}' @click="toDetail(item)">
			      <img :style='{"width":"100%","objectFit":"cover","display":"block","height":"200px"}' v-if="item.yaopintupian && item.yaopintupian.substr(0,4)=='http'" :src="item.yaopintupian" alt="">
			      <img :style='{"width":"100%","objectFit":"cover","display":"block","height":"200px"}' v-else :src="baseUrl + (item.yaopintupian?item.yaopintupian.split(',')[0]:'')" alt="">
			      <div :style='{"padding":"4px 5px 0","color":"#343434","textAlign":"center","width":"100%","lineHeight":"30px","fontSize":"14px","fontWeight":"600"}'>{{item.yaopinmingcheng}}</div>
			      <!-- <div :style='{"padding":"0 5px","lineHeight":"20px","fontSize":"14px","color":"#999","textAlign":"center"}'>2022-02-02</div> -->
			    </div>
			  </div>
			</div>
		<el-tabs class="detail" :style='{"border":"0px solid #DCDFE6","width":"100%","boxShadow":"0 0px 0px 0 rgba(0, 0, 0, .1)","margin":"20px 0 0","background":"#fff","order":"6"}' v-model="activeName" type="border-card">
				...
				<el-form class="add comment" :style='{"padding":"0","margin":"20px 0"}' :model="form" :rules="rules" ref="form">
					...
					<el-form-item class="btn" :style='{"width":"100%","margin":"10px 0px 0 60px","height":"auto"}'>
						<el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#0F672D","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="submitForm('form')">立即发布</el-button>
    ...
    methods: {
      ...
      addCart() {
            ...
            if (this.detail.onelimittimes > 0 && this.detail.onelimittimes < this.buynumber) {
                this.$message.error(`每人每次只能购买${this.detail.onelimittimes}件`);
                return
            }
            // 库存不足
