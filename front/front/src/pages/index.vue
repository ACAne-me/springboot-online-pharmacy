<template>
	<div class="main-containers" >
		...
		<div class="top-container" :style='{"border-top":"50px solid #green","padding":"0 10%","alignItems":"center","display":"flex","justifyContent":"center","overflow":"hidden","top":"0","left":"0","flexWrap":"wrap","background":"#fff","width":"100%","height":"150px","zIndex":"1002"}'>
			<!-- info -->
			<div :style='{"padding":"0 30px","alignItems":"center","left":"10%","background":"#none","display":"flex","width":"320px","position":"absolute","justifyContent":"center","zIndex":"1002","height":"90px"}'>
			  <span :style='{"padding":"0px","lineHeight":"1.2","fontSize":"26px","color":"#000","fontWeight":"600"}'>基于Spring Boot的网上药房</span>
			</div>
			<!-- weather -->
			<div class="weather" :style='{"padding":"0 20px 0 10vw","alignItems":"center","top":"0px","left":"0","display":"flex","position":"absolute","justifyContent":"center"}'>
				<div :style='{"padding":"0 2px","fontSize":"14px","lineHeight":"50px","color":"black"}'>{{weather.city}}</div>
				<div :style='{"padding":"0 2px","fontSize":"14px","lineHeight":"50px","color":"black"}'>{{weather.tem}}°</div>
				<div :style='{"padding":"0 2px","fontSize":"14px","lineHeight":"50px","color":"black"}'>{{weather.wea}}</div>
				<div :style='{"padding":"0 2px","fontSize":"14px","lineHeight":"50px","color":"black"}'>{{weather.win}}</div>
				<div :style='{"padding":"0 2px","fontSize":"14px","lineHeight":"50px","color":"black"}'>{{weather.win_speed}}</div>
			</div>
			<el-button v-if="Token" class="btn-myOrder btn-service" @click.native="goOrder">
					我的订单
			</el-button>
			<el-button v-if="Token" class="btn-service" @click.native="goStoreUp">
					我的收藏
			</el-button>
			...
			<el-button v-if="Token" class="btn-shop" @click.native="goMenu('/index/cart')">
				<span class="icon iconfont icon-wuliu8" :style='{"color":"black","fontSize":"16px","display":"none"}'></span>
				    购物车
			</el-button>
			<el-button v-if="Token" class="btn-service" @click.native="goChat">
				<span class="icon iconfont icon-touxiang09" :style='{"color":"black","fontSize":"18px","display":"none"}'></span>
					客服中心
			</el-button>
			<div id="search" class="search" :style='{"margin":"0 10px","overflow":"hidden","borderRadius":"10px","flexWrap":"wrap","background":"#fff","display":"none","height":"auto"}'>
				...
				<div :style='{"margin":"0 10px 0 0","flex":"1"}' class="input" v-if="queryIndex==0">
					<el-input v-model="yaopinxinxiyaopinmingcheng" placeholder="药品名称"></el-input>
				</div>
				<div :style='{"margin":"0"}' class="btn" v-if="queryIndex==0">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0","outline":"none","color":"#ECF2EA","background":"red","width":"auto","lineHeight":"44px","fontSize":"14px","height":"44px"}' type="primary" @click="search('yaopinxinxi')">
      ...
      <el-button v-if="Token" @click="logout" type="primary" icon="el-icon-search">退出</el-button>
		...
		<div class="menu-preview" :style='{"padding":"0px 0px 0px 100px","overflow":"auto","top":"50px","left":"10%","background":"#fff","bottom":"0","fontSize":"0px","zIndex":"1001"}'>
			<el-scrollbar wrap-class="scrollbar-wrapper">
				...
				<el-menu  class="el-menu-vertical-demo" :default-active="activeMenu" :style='{"border":0,"padding":"0 60px 0 80px","listStyle":"none","margin":"0","position":"relative","background":"#fff"}' :unique-opened="true" mode="horizontal" :router="true" @select="handleSelect">
...
export default {
    data() {
		...
		yaopinxinxiyaopinmingcheng: '',
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","首页总数"],"appFrontIcon":"cuIcon-attentionfavor","buttons":["新增","查看","修改","删除","首页总数"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-cardboard","buttons":["新增","查看","修改","删除"],"menu":"药品分类","menuJump":"列表","tableName":"yaopinfenlei"}],"menu":"药品分类管理"},{"child":[{"allButtons":["新增","查看","修改","删除","药品库存统计","药品分类统计","查看评论","首页总数","首页统计","药品入库"],"appFrontIcon":"cuIcon-rank","buttons":["新增","查看","修改","删除","查看评论","首页总数","首页统计","药品入库"],"menu":"药品信息","menuJump":"列表","tableName":"yaopinxinxi"}],"menu":"药品信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-cardboard","buttons":["查看","修改","删除"],"menu":"入库信息","menuJump":"列表","tableName":"rukuxinxi"}],"menu":"入库信息管理"},{"child":[{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-wenzi","buttons":["查看","修改"],"menu":"关于我们","tableName":"aboutus"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告资讯","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-link","buttons":["新增","查看","修改","删除"],"menu":"友情链接","tableName":"friendlink"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告资讯分类","tableName":"newstype"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-service","buttons":["新增","查看","修改","删除"],"menu":"客服中心","tableName":"chat"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-similar","buttons":["新增","查看","修改","删除"],"menu":"智能助手","tableName":"chathelper"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-send","buttons":["查看","修改"],"menu":"轮播图管理","tableName":"config"}],"menu":"系统管理"},{"child":[{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","发货","物流","核销"],"appFrontIcon":"cuIcon-full","buttons":["查看","发货","物流"],"menu":"已支付订单","tableName":"orders/已支付"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","物流","退货审核"],"appFrontIcon":"cuIcon-medal","buttons":["查看","退货审核","物流","品销额","类销额"],"menu":"已完成订单","tableName":"orders/已完成"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额"],"appFrontIcon":"cuIcon-pic","buttons":["查看"],"menu":"已取消订单","tableName":"orders/已取消"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","物流"],"appFrontIcon":"cuIcon-addressbook","buttons":["查看"],"menu":"已退款订单","tableName":"orders/已退款"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","确认收货","物流"],"appFrontIcon":"cuIcon-skin","buttons":["查看"],"menu":"已发货订单","tableName":"orders/已发货"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额"],"appFrontIcon":"cuIcon-addressbook","buttons":["查看"],"menu":"未支付订单","tableName":"orders/未支付"}],"menu":"订单管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","药品库存统计","药品分类统计","查看评论","首页总数","首页统计","药品入库"],"appFrontIcon":"cuIcon-paint","buttons":["查看"],"menu":"药品信息列表","menuJump":"列表","tableName":"yaopinxinxi"}],"menu":"药品信息模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","药品库存统计","药品分类统计","查看评论","首页总数","首页统计","药品入库"],"appFrontIcon":"cuIcon-paint","buttons":["查看"],"menu":"药品信息列表","menuJump":"列表","tableName":"yaopinxinxi"}],"menu":"药品信息模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
    ...
    created() {
        ...
        if(localStorage.getItem('frontToken') && localStorage.getItem('frontToken')!=null) {
			this.getSession()
            this.saveChathelper('主人，我是您的智能助手晓东，请问有什么可以帮您！');
            this.getChatList();
        }
    },
    mounted() {
    ...
    methods: {
      search(tablename) {
		...
		goOrder(){
			this.goMenu('/index/shop-order/order')
		},
		goStoreUp(){
			localStorage.setItem('storeupType', 1);
			this.goMenu('/index/storeup')
		},
		goMenu(path) {
...
<style rel="stylesheet/scss" lang="scss" scoped>
	...
	.main-containers .btn-service {
				...
				background: url(http://codegen.caihongy.cn/20231108/c010013dae06483fba75c3c49999b346.png) no-repeat left center;
				width: auto;
				font-size: 16px;
				line-height: 32px;
				height: 32px;
	...
	.main-containers .btn-shop {
				...
				padding: 0 8px 0 30px;
				margin: 0 0 0 ;
				background: url(http://codegen.caihongy.cn/20231108/2cbf4eaee2a34e50926a90d2bb54dc85.png) no-repeat left center,;
				width: auto;
				font-size: 16px;
				line-height: 32px;
				height: 32px;
